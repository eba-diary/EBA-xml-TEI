    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <h2>Group and Family Names</h2>
                <ul>
                    <xsl:for-each select="distinct-values(//orgName/@ref)">
                        <xsl:sort/>
                        <li>
                            <b>
                                <xsl:value-of select="."/>
                            ...
                            <ul>
                                <xsl:for-each
                                    select="distinct-values($sarah//orgName[@ref=$nametobechecked])">
                                    <li>
                                        <xsl:text>“</xsl:text>
                                        <xsl:value-of select="."/>
                                        <xsl:text>”</xsl:text>
                ...
                <!--  <h2>Hotels</h2>
                <ul>
                    <xsl:for-each select="distinct-values(//sk:hotel/name/@ref)">
                        <xsl:sort/>
                        <li>
                            <b>
                                <xsl:value-of select="."/>
                            ...
                            <ul>
                                <xsl:for-each
                                    select="distinct-values($sarah//sk:hotel/name[@ref=$nametobechecked])">
                                    <li>
                                        <xsl:text>“</xsl:text>
                                        <xsl:value-of select="."/>
                                        <xsl:text>”</xsl:text>
                ...
                <h2>Names</h2>
                <ul>
                    <xsl:for-each select="distinct-values(//name/@type)">
                        <xsl:sort/>
                        <li>
                            <b>
                                <xsl:value-of select="."/>
                            ...
                            <ul>
                                <xsl:for-each
                                    select="distinct-values($sarah//name[@type=$nametobechecked])">
                                    <li>
                                        <xsl:text>“</xsl:text>
                                        <xsl:value-of select="."/>
                                        <xsl:text>”</xsl:text>
